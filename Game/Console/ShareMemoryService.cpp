...
bool CShareMemoryService::CreateShareMemory()
{
	m_hMapping = CreateFileMapping(INVALID_HANDLE_VALUE, NULL, PAGE_READWRITE, 0, sizeof(SHARED_MEMORY_DATA), US_MAP_NAME);
	if (!m_hMapping)
		return false;
